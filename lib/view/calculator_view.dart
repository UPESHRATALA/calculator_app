...
class _CalculatorViewState extends State<CalculatorView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('upesh Calculator App'),
      ),
      body: Padding(
          ...
          child: Column(
            children: [
              Text(
                history,
                style: TextStyle(
                    fontSize: 16, color: Color.fromARGB(164, 16, 26, 89)),
              ),
              TextFormField(
                  ...
                  itemBuilder: (context, index) {
                    return ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            operationList.contains(lstSymbols[index])
                                ? Color.fromARGB(255, 198, 185, 147)
                                : Colors.black,
